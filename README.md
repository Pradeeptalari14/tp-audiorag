...
> Speech transcript extractor matching search queries via Whisper and CLAP embedding spaces.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/audiorag/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-audiorag.git
cd tp-audiorag
```
...
```bash
kubectl port-forward deployment/tp-audiorag 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── audio_retriever.py     # Main configuration file
```
...
---
*Generated by [AudioRAG Studio](https://pradeeptalari14.github.io/portfolio/tools/audiorag/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
